...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--veya-void)" }}>
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50" style={{ background: "#0a0118", borderBottom: "1px solid rgba(212, 175, 55, 0.18)" }}>
      ...
      <footer className="relative z-10 mt-20 glass border-t border-[#7c3aed]/10">
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-zinc-800 text-sm">Guided by Violet · Illuminated by the Moon
