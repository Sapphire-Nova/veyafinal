...
export default function HerbModal({ herb, onClose }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-5 text-sm">
              <div>
                <p className="text-xs text-[#d4af37] uppercase tracking-widest mb-2">✨ Magical Properties</p>
                <p className="text-[#c4b5fd]/70 leading-relaxed">{herb.magical}</p>
              </div>

              <div>
                <p className="text-xs text-[#d4af37] uppercase tracking-widest mb-2">📖 Folklore & History</p>
                <p className="text-[#c4b5fd]/60 leading-relaxed italic">{herb.folklore}</p>
              </div>
            </div>
          </div>
        </div>
