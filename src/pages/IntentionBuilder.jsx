...
export default function IntentionBuilder() {
  ...
  return (
    <div className="bg-zinc-500 mx-auto px-4 py-12 max-w-5xl sm:px-6">
          ...
          {intentions.map((intent) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => toggleIntention(intent.id)} className="bg-[#1a0533]/40 text-slate-50 px-5 py-3 text-sm rounded-xl border transition-all border-[#7c3aed]/10 hover:border-[#7c3aed]/30">
      ...
      {/* Generate Button */}
      <div className="mb-12 text-center opacity-100">
        <Button
