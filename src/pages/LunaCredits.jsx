...
const PACKS = [
  {
    ...
    icon: Star,
    color: "#c4b5fd",
    perks: ["10 Luna Credits", "Ask the Priestess (5 readings)", "Intention Builder (5 spells)"],
  },
  {
    id: "moon",
    name: "Moon Pack",
    ...
    color: "#d4af37",
    popular: true,
    perks: ["25 Luna Credits", "Ask the Priestess (12 readings)", "Intention Builder (12 spells)", "Best value for seekers"],
  },
  {
    id: "priestess",
    name: "Priestess Pack",
    ...
    icon: Crown,
    color: "#f5e6a3",
    perks: ["60 Luna Credits", "Ask the Priestess (30 readings)", "Intention Builder (30 spells)", "Priority spiritual access"],
  },
];
